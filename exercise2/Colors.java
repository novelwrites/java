...
public class Colors {
    ...
    String[] colorful(String[] strings) {
        ...
        // return an array of strings that start with a color.  discard all the other strings.  If no strings start
        // with a color in the input array, return an empty array.
        return new String[]{};
    }
